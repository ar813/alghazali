                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div className="flex items-center gap-3 p-4 rounded-xl bg-neutral-50 dark:bg-neutral-900/50 border border-neutral-100 dark:border-neutral-800">
                            ...
                            <div className="space-y-0.5">
                                <p className="text-[10px] font-black text-neutral-400 uppercase tracking-tighter leading-none">Overall Status</p>
                                <p className="text-sm font-bold text-neutral-800 dark:text-neutral-200">{health.ok ? 'Running' : 'Issues Detected'}</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3 p-4 rounded-xl bg-neutral-50 dark:bg-neutral-900/50 border border-neutral-100 dark:border-neutral-800">
                            <div className="w-2 h-2 rounded-full bg-indigo-500 shadow-[0_0_8px_rgba(79,70,229,0.5)]" />
                            <div className="space-y-0.5">
                                <p className="text-[10px] font-black text-neutral-400 uppercase tracking-tighter leading-none">Config Setup</p>
                                <p className="text-sm font-bold text-neutral-800 dark:text-neutral-200">{(health.missingEnv || []).length} Missing Settings</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3 p-4 rounded-xl bg-neutral-50 dark:bg-neutral-900/50 border border-neutral-100 dark:border-neutral-800">
                            <div className="w-2 h-2 rounded-full bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.5)]" />
                            <div className="space-y-0.5">
                                <p className="text-[10px] font-black text-neutral-400 uppercase tracking-tighter leading-none">Security Alerts</p>
                                <p className="text-sm font-bold text-neutral-800 dark:text-neutral-200">{(health.issues || []).length} Alerts Found</p>
                            </div>
                        </div>
                    </div>
                ) : (
                    <div className="text-sm text-neutral-500 flex items-center gap-2 italic uppercase font-bold tracking-tighter">
                        <Bell size={16} className="text-neutral-400" /> System data unavailable
                    </div>
                )}
            </div>
        </div>
