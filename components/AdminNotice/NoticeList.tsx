        ...
        <div className="w-full space-y-4">
            ...
            {loading && items.length === 0 && (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-3">
                    {[...Array(3)].map((_, i) => (
                        <div key={i} className="bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-2xl p-5 animate-pulse">
                            <div className="h-4 bg-zinc-100 dark:bg-zinc-800 rounded w-1/4 mb-4"></div>
                            <div className="h-6 bg-zinc-100 dark:bg-zinc-800 rounded w-1/2 mb-2"></div>
                            <div className="h-10 bg-zinc-50 dark:bg-zinc-800/50 rounded w-full"></div>
                        </div>
                    ))}
                </div>
            )}
